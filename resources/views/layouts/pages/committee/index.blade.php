        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">All Member<span class="bg-blue-500 text-white rounded px-1 text-xs py-0.5"></span></h4>
                    {{-- @can('Role create') --}}
                    <a href="{{ route('committee.create') }}" class="btn btn-sm btn-primary"><i class="fa fa-plus"></i><span class="btn-icon-add"></span>Create user</a>
                    {{-- @endcan --}}
                </div>
                    ...
                    <div class="table-responsive">
                        <table id="example3" class="display" style="min-width: 845px">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td><img class="img-fluid" src="{{ $user->profile_photo_path }}" width="40" height="40" alt=""></td>
                                    ...
                                    <td class="d-flex justify-content-end">
                                        {{-- @can('User edit') --}}
                                        <a href="{{ route('committee.edit', $user->id) }}" class="btn btn-success shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
                                        {{-- @endcan --}}
                                        @can('User delete')
