...
<x-guest-layout>
    <div class="content-wrapper py-4" style="background-image: url('{{asset('public/extra-pages/login')}}/background-bubble.jpg');">
        <div class="login-form">
            ...
            <div class="header">
                <h1 style="font-size: 24px;color: #34ad54;font-weight:500">Your Registation Complete Successfully</h1>
            ...
            <!-- Message Show -->
            <h5 style="color: #00ff37;margin: 10px 0px; font-family:arial;font-size:18px">Verification Link Sent to your Email </h5>
